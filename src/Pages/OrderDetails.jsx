  ...
  return (
    ...
    <div className="grid grid-cols-2 gap-4">
      ...
      <div className='flex flex-col justify-center items-start gap-2'>
        ...
        <p>partition: <span className='text-secondary'>{order.partition}</span></p>
        <p>Location: <span className='text-secondary'>{order.location}</span></p>
        <p>Location: <span className='text-secondary'>{order.customer_usage}</span></p>
        <p>Number of Items: <span className='text-secondary'>{order.number_of_partition}</span></p>
